from flask import Flask, render_template, request, session #THE OG FILE 
import random
...
def load_questions(selected_files, proficiency, num_questions=20):
    ...
    # Handle any remaining questions needed due to rounding
...
def result():
    ...
    for answer in incorrect_answers:
        ...
        if language in incorrect_count_by_language:
            incorrect_count_by_language[language] += 1
        else:
            incorrect_count_by_language[language] = 1
